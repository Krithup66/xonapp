...
// หน้า xon (node-id=3015-7051), หน้าการเงิน (node-id=3146-6034), และ หน้า Trade (node-id=3261-4947)
const ICON_URLS = {
...
// รองรับทั้งหน้า xon, Trade และหน้าอื่นๆ
const HomeNavIcon = ({ size = 20, isTradePage = false, isXonPage = false }: { size?: number; isTradePage?: boolean; isXonPage?: boolean }) => {
...
const FinanceNavIcon = ({ size = 20, isTradePage = false, isXonPage = false }: { size?: number; isTradePage?: boolean; isXonPage?: boolean }) => {
...
const CommunityNavIcon = ({ size = 34, height = 17, isTradePage = false, isXonPage = false }: { size?: number; height?: number; isTradePage?: boolean; isXonPage?: boolean }) => {
  ...
  return <SvgUri uri={uri} width={size} height={height || size} />;
};

const AssistantNavIcon = ({ size = 20, isTradePage = false, isXonPage = false }: { size?: number; isTradePage?: boolean; isXonPage?: boolean }) => {
...
const TradeNavIcon = ({ size = 20, isTradePage = false, isXonPage = false }: { size?: number; isTradePage?: boolean; isXonPage?: boolean }) => {
      ...
      {isXonPage ? (
        ...
        <>
          ...
          <TouchableOpacity style={styles.navItem} onPress={() => router.push('/community')}>
            <CommunityNavIcon size={scale(34)} height={scale(17)} isXonPage={true} />
        ...
        <>
          ...
          {/* ชุมชน / Community */}
          <TouchableOpacity style={styles.navItem} onPress={() => router.push('/community')}>
            <CommunityNavIcon size={scale(34)} height={scale(17)} isTradePage={true} />
            <Text style={[styles.navLabel, getTextStyle('/community')]}>ชุมชน</Text>
          </TouchableOpacity>
        ...
        <>
          ...
          {/* ชุมชน / Community */}
          <TouchableOpacity style={styles.navItem} onPress={() => router.push('/community')}>
            <CommunityNavIcon size={scale(34)} height={scale(17)} isTradePage={false} isXonPage={false} />
            <Text style={[styles.navLabel, getTextStyle('/community')]}>ชุมชน</Text>
          </TouchableOpacity>
